...
/**
 *  \file       scrumsprint_agenda.php
 *  \ingroup    scrumproject
 *  \brief      Tab of events on ScrumSprint
 */
...
$hookmanager->initHooks(array('scrumsprintagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("ScrumSprint"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnScrumSprint"), '', '');
