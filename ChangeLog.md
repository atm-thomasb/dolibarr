...
## Version 1.14
- FIX : filter soc and thirdparty *09/11/2022* - 1.14.2
  - FIX : umdate time on kanban 
  - FIX : remove statut card on scrumcard_card.php
  - FIX : label on US planned
  - FIX : move butNewKanban to first position
