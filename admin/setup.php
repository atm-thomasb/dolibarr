...
/**
 * \file    scrumproject/admin/setup.php
 * \ingroup scrumproject
 * \brief   ScrumProject setup page.
 */
...
} elseif ($action == 'specimen')
{
	...
	{
		$file = dol_buildpath($reldir."core/modules/scrumproject/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
		if (file_exists($file))
		{
			$filefound = 1;
...
elseif ($action == 'setmod') {
	...
	if (!empty($tmpobjectkey)) {
		$constforval = 'SCRUMPROJECT_'.strtoupper($tmpobjectkey)."_ADDON";
