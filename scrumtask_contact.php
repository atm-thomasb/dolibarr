...
/**
 *  \file       scrumtask_contact.php
 *  \ingroup    scrumproject
 *  \brief      Tab for contacts linked to ScrumTask
 */
...
$hookmanager->initHooks(array('scrumtaskcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->hasRight('scrumproject','scrumtask','write');
...
$title = $langs->trans('ScrumTask')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
