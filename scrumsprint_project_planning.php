...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'scrumsprintlistprojectplanning'; // To manage different context of search
...
$hookmanager->initHooks(array('scrumsprintlistprojectplanning')); // Note that conf->hooks_modules contains array
