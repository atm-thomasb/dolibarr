...
if ($action == 'create')
{
	print load_fiche_titre($langs->trans("NewObject", $langs->transnoentitiesnoconv("ScrumCard")), '', $object->picto);
...
{
	print load_fiche_titre($langs->trans("ScrumCard"), '', $object->picto);
