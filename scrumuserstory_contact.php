...
/**
 *  \file       scrumuserstory_contact.php
 *  \ingroup    scrumproject
 *  \brief      Tab for contacts linked to ScrumUserStory
 */
...
$hookmanager->initHooks(array('scrumuserstorycontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->hasRight('scrumproject','scrumuserstory','write');
...
$title = $langs->trans('ScrumUserStory')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
