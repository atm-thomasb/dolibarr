...
ALTER TABLE llx_scrumproject_scrumkanban ADD INDEX idx_scrumproject_scrumkanban_fk_project (fk_project);
ALTER TABLE llx_scrumproject_scrumkanban ADD CONSTRAINT llx_scrumproject_scrumkanban_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
ALTER TABLE llx_scrumproject_scrumkanban ADD INDEX idx_scrumproject_scrumkanban_status (status);
-- END MODULEBUILDER INDEXES

--ALTER TABLE llx_scrumproject_scrumkanban ADD UNIQUE INDEX uk_scrumproject_scrumkanban_fieldxy(fieldx, fieldy);
