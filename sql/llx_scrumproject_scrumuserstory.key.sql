...
--ALTER TABLE llx_scrumproject_scrumuserstory ADD UNIQUE INDEX uk_scrumproject_scrumuserstory_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_scrumproject_scrumuserstory ADD CONSTRAINT llx_scrumproject_scrumuserstory_fk_field FOREIGN KEY (fk_field) REFERENCES llx_scrumproject_myotherobject(rowid);
