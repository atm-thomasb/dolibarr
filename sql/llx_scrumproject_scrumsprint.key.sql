...
ALTER TABLE llx_scrumproject_scrumsprint ADD INDEX idx_scrumproject_scrumsprint_status (status);
-- END MODULEBUILDER INDEXES

--ALTER TABLE llx_scrumproject_scrumsprint ADD UNIQUE INDEX uk_scrumproject_scrumsprint_fieldxy(fieldx, fieldy);

--ALTER TABLE llx_scrumproject_scrumsprint ADD CONSTRAINT llx_scrumproject_scrumsprint_fk_field FOREIGN KEY (fk_field) REFERENCES llx_scrumproject_myotherobject(rowid);
