...
ALTER TABLE llx_scrumproject_scrumcard ADD INDEX idx_scrumproject_scrumcard_fk_rank (fk_rank);
ALTER TABLE llx_scrumproject_scrumcard ADD INDEX idx_scrumproject_scrumcard_fk_scrum_kanbanlist (fk_scrum_kanbanlist);
ALTER TABLE llx_scrumproject_scrumcard ADD CONSTRAINT llx_scrumproject_scrumcard_fk_scrum_kanbanlist FOREIGN KEY (fk_scrum_kanbanlist) REFERENCES llx_scrumproject_scrumkanbanlist(rowid);
