...
/**
 *  \file       scumuserstorysprint_contact.php
 *  \ingroup    scrumproject
 *  \brief      Tab for contacts linked to ScumUserStorySprint
 */
...
$hookmanager->initHooks(array('scumuserstorysprintcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->scrumproject->scumuserstorysprint->write;
...
$title = $langs->trans('ScumUserStorySprint')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
