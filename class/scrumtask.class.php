...
class ScrumTask extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_scrum_user_story_sprint' => array('type' => 'integer:ScumUserStorySprint:scrumproject/class/scumuserstorysprint.class.php:1', 'label' => 'ScrumUserStorySprint', 'enabled' => '1', 'position' => 52, 'notnull' => -1, 'visible' => -1, 'index' => 1, 'validate' => '1', 'foreignkey'=>'scrumproject_scumuserstorysprint.rowid'),
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picto('', $this->picto).' <u>'.$langs->trans("ScrumTask").'</u>';
