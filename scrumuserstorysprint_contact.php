...
/**
 *  \file       scrumuserstorysprint_contact.php
 *  \ingroup    scrumproject
 *  \brief      Tab for contacts linked to ScrumUserStorySprint
 */
...
$hookmanager->initHooks(array('scrumuserstorysprintcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->hasRight('scrumproject','scrumuserstorysprint','write');
...
$title = $langs->trans('ScrumUserStorySprint')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
