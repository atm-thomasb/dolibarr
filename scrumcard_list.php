...
/**
 *   	\file       scrumcard_list.php
 *		\ingroup    scrumproject
 *		\brief      List page for scrumcard
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'scrumcardlist'; // To manage different context of search
...
$hookmanager->initHooks(array('scrumcardlist')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->scrumproject->scrumcard->write;
$permissiontodelete = $user->rights->scrumproject->scrumcard->delete;
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'ScrumCard';
	$objectlabel = 'ScrumCard';
...
//$help_url="EN:Module_ScrumCard|FR:Module_ScrumCard_FR|ES:Módulo_ScrumCard";
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("ScrumCards"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/scrumproject/scrumcard_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/scrumproject/scrumcard_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendScrumCardRef";
$modelmail = "scrumcard";
$objecttmp = new ScrumCard($db);
