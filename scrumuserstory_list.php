...
/**
 *   	\file       scrumuserstory_list.php
 *		\ingroup    scrumproject
 *		\brief      List page for scrumuserstory
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'scrumuserstorylist'; // To manage different context of search
...
$hookmanager->initHooks(array('scrumuserstorylist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ScrumUserStory';
	$objectlabel = 'ScrumUserStory';
