...
/**
 *   	\file       scrumsprintuser_list.php
 *		\ingroup    scrumproject
 *		\brief      List page for scrumsprintuser
 */
...
$permissiontoadd = $user->rights->scrumproject->scrumsprintuser->write;
$permissiontodelete = $user->rights->scrumproject->scrumsprintuser->delete;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ScrumSprintUser';
	$objectlabel = 'ScrumSprintUser';
...
//$help_url="EN:Module_ScrumSprintUser|FR:Module_ScrumSprintUser_FR|ES:Módulo_ScrumSprintUser";
$help_url = '';
$title = $langs->transnoentitiesnoconv("ScrumSprintUsers");
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/scrumproject/scrumsprintuser_card.php', 1).'?id='.$id);
	exit;
}
...
$topicmail = "SendScrumSprintUserRef";
$modelmail = "scrumsprintuser";
$objecttmp = new ScrumSprintUser($db);
