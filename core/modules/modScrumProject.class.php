...
class modScrumProject extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->depends = array('always1'=>'modAdvancedKanban');
		...
		/**
		 * DROIT POUR SCRUM USER STORY SPRINT TASK
		 */
        ...
        $this->menu[$r++]=array(
            ...
            'url'=>'/scrumproject/scrumsprint_list.php?mainmenu=project',
        ...
        $this->menu[$r++]=array(
            ...
            'mainmenu'=>'project',
            'leftmenu'=>'scrumsprintnew',
            'url'=>'/scrumproject/scrumsprint_card.php?mainmenu=project&leftmenu=scrumsprint&action=create',
            // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'langs'=>'scrumproject@scrumproject',
            'position'=>1100+$r,
            // Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'ProjectPlanningReportMenu',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumsprintprojectplanning',
			'url'=>'/scrumproject/scrumsprint_project_planning.php?mainmenu=project&leftmenu=scrumsprintprojectplanning',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'fk_menu'=>'fk_mainmenu=project,fk_leftmenu=scrumsprintlist',
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'StatusScrumSprintDraft',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumsprintlist0',
			'url'=>'/scrumproject/scrumsprint_list.php?mainmenu=project&leftmenu=scrumsprintlist&search_status=0',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'mainmenu'=>'project',
			'leftmenu'=>'scrumsprintlist1',
			'url'=>'/scrumproject/scrumsprint_list.php?mainmenu=project&leftmenu=scrumsprintlist&search_status=1',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'mainmenu'=>'project',
			'leftmenu'=>'scrumsprintlist2',
			'url'=>'/scrumproject/scrumsprint_list.php?mainmenu=project&leftmenu=scrumsprintlist&search_status=2',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'mainmenu'=>'project',
			'leftmenu'=>'scrumsprintlist3',
			'url'=>'/scrumproject/scrumsprint_list.php?mainmenu=project&leftmenu=scrumsprintlist&search_status=3',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'ScrumUserStory',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumuserstory',
			'url'=>'/scrumproject/scrumuserstory_list.php?mainmenu=project&leftmenu=scrumuserstory',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'NewScrumUserStory',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumuserstorynew',
			'url'=>'/scrumproject/scrumuserstory_card.php?mainmenu=project&leftmenu=scrumuserstory&action=create',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'url'=>'/scrumproject/scrumuserstory_list.php?mainmenu=project&leftmenu=scrumuserstorylist',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'Liste User Story Planifiées',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumuserstorylist',
			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'StatusScrumUserStoryDraft',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumuserstorylist0',
			'url'=>'/scrumproject/scrumuserstory_list.php?mainmenu=project&leftmenu=scrumuserstorylist&search_status=0',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'StatusScrumUserStoryReady',
			'mainmenu'=>'project',
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'StatusScrumUserStoryDone',
			'mainmenu'=>'project',
			'leftmenu'=>'scrumuserstorylist2',
			'url'=>'/scrumproject/scrumuserstory_list.php?mainmenu=project&leftmenu=scrumuserstorylist&search_status=2',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
...
//			// This is a Left menu entry
//			'type'=>'left',
//			'titre'=>'ScrumUserStorySprint',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprint',
//			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
...
//		$this->menu[$r++]=array(
//			// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
//			'fk_menu'=>'fk_mainmenu=project,fk_leftmenu=scrumuserstorysprint',
//			// This is a Left menu entry
//			'type'=>'left',
//			'titre'=>'NewScrumUserStorySprint',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprintnew',
//			'url'=>'/scrumproject/scrumuserstorysprint_card.php?action=create',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
//			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
//			'titre'=>'List',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprintlist',
//			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
...
//		$this->menu[$r++]=array(
//			// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
//			'fk_menu'=>'fk_mainmenu=project,fk_leftmenu=scrumuserstorysprintlist',
//			// This is a Left menu entry
//			'type'=>'left',
//			'titre'=>'StatusScrumUserStorySprintDraft',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprintlist0',
//			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint&search_status=0',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
//			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
//			// This is a Left menu entry
//			'type'=>'left',
//			'titre'=>'StatusScrumUserStorySprintReady',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprintlist1',
//			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint&search_status=1',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
//			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
//			// This is a Left menu entry
//			'type'=>'left',
//			'titre'=>'StatusScrumUserStorySprintDone',
//			'mainmenu'=>'project',
//			'leftmenu'=>'scrumuserstorysprintlist2',
//			'url'=>'/scrumproject/scrumuserstorysprint_list.php?mainmenu=project&leftmenu=scrumuserstorysprint&search_status=2',
//			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
//			'langs'=>'scrumproject@scrumproject',
//			'position'=>1100+$r,
//			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
...
//		);
		...
		$this->menu[$r++]=array(
			...
			'url'=>'/advancedkanban/advkanban_list.php?mainmenu=project&leftmenu=scrumkanban',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			...
			// Use 'perms'=>'$user->rights->scrumproject->level1->level2' if you want your menu with a permission rules
			'perms'=>'$user->rights->advancedkanban->advkanban->read',
		...
		$this->menu[$r++]=array(
			...
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'enabled'=>'$conf->advancedkanban->enabled && !empty($conf->global->SP_ENABLE_KANBAN)',
			// Use 'perms'=>'$user->rights->scrumproject->level1->level2' if you want your menu with a permission rules
			'perms'=>'$user->rights->advancedkanban->advkanban->read',
			'target'=>'',
			// 0=Menu for internal users, 1=external users, 2=both
		...
		$this->menu[$r++]=array(
			...
			'url'=>'/advancedkanban/advkanban_list.php?mainmenu=project&leftmenu=scrumkanban&search_status=0',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'enabled'=>'$conf->advancedkanban->enabled && $leftmenu==\'scrumkanban\'  && !empty($conf->global->SP_ENABLE_KANBAN)',
			// Use 'perms'=>'$user->rights->scrumproject->level1->level2' if you want your menu with a permission rules
			'perms'=>'$user->rights->advancedkanban->advkanban->read',
			'target'=>'',
			// 0=Menu for internal users, 1=external users, 2=both
		...
		$this->menu[$r++]=array(
			...
			'url'=>'/advancedkanban/advkanban_list.php?mainmenu=project&leftmenu=scrumkanban&search_status=1',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'url'=>'/advancedkanban/advkanban_list.php?mainmenu=project&leftmenu=scrumkanban&search_status=2',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r++]=array(
			...
			'mainmenu'=>'project',
			'leftmenu'=>'scrumkanbancat',
			'url'=>'/categories/index.php?type=advkanbancard&fk_mainmenu=project&fk_leftmenu=scrumkanban',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'scrumproject@scrumproject',
			'position'=>1100+$r,
			// Define condition to show or hide menu entry. Use '$conf->scrumproject->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
