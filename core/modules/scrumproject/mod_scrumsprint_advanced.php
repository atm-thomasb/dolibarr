...
/**
 * \file       htdocs/core/modules/scrumproject/mod_scrumsprint_advanced.php
 * \ingroup    scrumproject
 * \brief      File containing class for advanced numbering model of ScrumSprint
 */
 ...
 */
class mod_scrumsprint_advanced extends ModeleNumRefScrumSprint
{
	/**
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'scrumproject_scrumsprint', 'ref', '', null, $date);
