...
/**
 *	Class to manage PDF template standard_scrumtask
 */
class pdf_standard_scrumtask extends ModelePDFScrumTask
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_SCRUMTASK_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->scrumproject->dir_output.'/scrumtask') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->scrumproject->dir_output.'/scrumtask';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->scrumproject->dir_output.'/scrumtask/'.$objectref;
