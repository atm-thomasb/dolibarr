...
/**
 *  \file       core/modules/scrumproject/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_scrumuserstory
 */
class pdf_standard_scrumuserstory extends ModelePDFScrumUserStory
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_SCRUMUSERSTORY_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->scrumproject->dir_output.'/scrumuserstory') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->scrumproject->dir_output.'/scrumuserstory';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->scrumproject->dir_output.'/scrumuserstory/'.$objectref;
	...
	{
		global $conf;
		$showdetails = getDolGlobalString('MAIN_GENERATE_DOCUMENTS_SHOW_FOOT_DETAILS',0);
