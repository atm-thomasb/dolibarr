...
/**
 *  \file       scrumuserstory_note.php
 *  \ingroup    scrumproject
 *  \brief      Tab for notes on ScrumUserStory
 */
...
$hookmanager->initHooks(array('scrumuserstorynote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('ScrumUserStory'), $help_url);
