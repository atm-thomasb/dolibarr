...
$permissionnote = $user->hasRight('scrumproject','scrumuserstorysprint','write'); // Used by the include of actions_setnotes.inc.php
$permissiondellink = $user->hasRight('scrumproject','scrumuserstorysprint','write'); // Used by the include of actions_dellink.inc.php
...
if (($id || $ref) && $action == 'edit') {
	print load_fiche_titre($langs->trans("ScrumUserStorySprint"), '', $object->picto);
...
//			print dolGetButtonAction($langs->trans('ToClone'), '', 'default', $_SERVER['PHP_SELF'].'?id='.$object->id.(!empty($object->socid)?'&socid='.$object->socid:'').'&action=clone&token='.newToken(), '', $permissiontoadd);
	...
	if ($action != 'presend') {
		...
		if ($includedocgeneration) {
			...
			$genallowed = $user->hasRight('scrumproject','scrumuserstorysprint','read'); // If you can read, you can build the PDF to read content
			$delallowed = $user->hasRight('scrumproject','scrumuserstorysprint','write'); // If you can create/edit, you can remove a file on card
