...
/**
 *   	\file       scrumuserstorysprint_list.php
 *		\ingroup    scrumproject
 *		\brief      List page for scrumuserstorysprint
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'scrumuserstorysprintlist'; // To manage different context of search
...
$hookmanager->initHooks(array('scrumuserstorysprintlist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ScrumUserStorySprint';
	$objectlabel = 'ScrumUserStorySprint';
...
$objecttmp = new ScrumUserStorySprint($db);
