...
/**
 *  \file       scrumsprint_note.php
 *  \ingroup    scrumproject
 *  \brief      Tab for notes on ScrumSprint
 */
...
$hookmanager->initHooks(array('scrumsprintnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('ScrumSprint'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("ScrumSprint"), -1, $object->picto);
